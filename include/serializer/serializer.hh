...
public:
  ...
  // write a vector
  //===------------------------------------------------===
  virtual void OnVectorBegin(size_t size) {}
  virtual void OnVectorEnd(size_t size) {}
  virtual void OnVectorItemBegin(size_t maxSize, size_t curSize) {}
  virtual void OnVectorItemEnd(size_t maxSize, size_t curSize) {}
  ...
  //===------------------------------------------------===
  virtual void OnUnorderedMapBegin(size_t size) {}
  virtual void OnUnorderedMapEnd(size_t size) {}
  ...
  // write a set
  //===------------------------------------------------===
  virtual void OnSetBegin(size_t size) {}
  virtual void OnSetEnd(size_t size) {}
