...
private:
  ...
  auto
  GetRoot() -> yyjson_mut_val * {
    return stack.front();
  }
  inline auto
  GetCurrent() -> yyjson_mut_val * {
    return stack.back();
  }
  ...
  void
  PushValue(yyjson_mut_val *val);
  void
  PruneEmptyObject(yyjson_mut_val *obj);
...
public:
  ...
  OnPairBegin() final;
  void
  OnPairKeyBegin() final;
  void
  OnPairValueBegin() final;
  void
  OnPairEnd() final;
  ...
  void
  OnUnorderedMapEnd(size_t size) final;
  void
  OnUnorderedMapItemBegin() final;
  void
  OnUnorderedMapItemEnd() final;
  void
  OnUnorderedMapKeyBegin() final;
  void
  OnUnorderedMapValueBegin() final;
